...
import { OMNIDEF } from './getAccountsAccToLicenseNumberGetRelatedConTooEnglish_def.js';
import tmpl from './getAccountsAccToLicenseNumberGetRelatedConTooEnglish.html';
import tmpl_nds from './getAccountsAccToLicenseNumberGetRelatedConTooEnglish_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class getAccountsAccToLicenseNumberGetRelatedConTooEnglish extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
